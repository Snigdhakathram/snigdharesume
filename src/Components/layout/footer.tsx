                ...
                return (
                  <Magnetic key={link.title}>
                    <Link
                      ...
                      className="w-12 h-12 flex items-center justify-center rounded-full bg-neutral-100 border border-neutral-200 text-neutral-600 hover:bg-neutral-200 hover:text-black transition-all"
