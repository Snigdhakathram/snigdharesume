...
export default function ProjectCard({
  ...
  return (
    <motion.div
      ...
      className="bg-neutral-100 rounded-2xl overflow-hidden border border-neutral-300/50 hover:border-neutral-400/80 transition-all duration-300"
    >
      ...
      <div className="p-6 flex flex-col">
        ...
        <p className="text-sm text-justify text-neutral-600 mb-4 leading-relaxed line-clamp-3">
          {description}
        </p>
